...
int main(int argc, char** argv) {
    ...
    std::string topics_arg = "notifications,alerts,metrics";  // Default topics for publisher2
    std::string content = "Hello from publisher2!";
    ...
    int counter = 0;
    bool use_round_robin = true;  // Set to true to alternate between topics
